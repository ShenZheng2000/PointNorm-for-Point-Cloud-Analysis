...
def train(args, io):
    ...
    model = models.__dict__[args.model](num_classes=50,
                                        ...
                                        use_xyz=args.use_xyz).to(device)
    io.cprint(str(model))
    ...
    # =========== Dataloader =================
    train_data = PartNormalDataset(npoints=2048, split='trainval', normalize=False, use_translate = args.use_translate, use_rotate = args.use_rotate)
    ...
    if args.use_sgd:
        ...
        print("Use AdamW")
        opt = optim.AdamW(model.parameters(), lr=args.lr, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.01)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_xyz', type=bool, default=False, help='whether to use xyz')
